...
interface ReadingHistory { id: string; articleId: string; articleTitle: string; category?: string; scrollPos: number; timestamp: number }
interface ListeningHistory { id: string; bookId: string; trackId: string; trackTitle: string; bookTitle: string; progress: number; timestamp: number }
